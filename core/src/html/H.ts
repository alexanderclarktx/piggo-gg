...
export const HButton = ({ id, style, onClick, onHover, onHoverOut }: HParams = {}, child1?: HTMLElement, child2?: HTMLElement, child3?: HTMLElement, child4?: HTMLElement): HTMLButtonElement => {
  const b = HtmlButton({
    style: style ?? {},
    onClick: onClick ?? (() => { }),
    onHover: onHover ?? (() => { }),
