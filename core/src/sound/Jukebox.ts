    ...
    components: {
      ...
      renderable: Renderable({
        ...
        onRender: (r) => {
          ...
          if (randomInt(1000) === 1) state = "play"

          if (platterMarks) platterMarks.rotation += 0.01
          ...
          if (arm) {
            ...
            if (arm.rotation >= -Math.PI / 2) {
              arm.rotation += 0.01
            } else if (arm.rotation <= 0) {
              arm.rotation -= 0.01
            }

            // if (arm.rotation > Math.PI) {
            //   arm.rotation += 0.01
            // } else 
          }
        },
