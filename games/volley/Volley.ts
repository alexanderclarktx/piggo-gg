import {
  Action, Actions, Background, CameraSystem, Character, Collider, Debug, Entity, GameBuilder, Input,
  LineWall, loadTexture, min, Move, Networked, Player, Point,
  Position, Renderable, SpawnSystem, SystemBuilder, WASDInputMap
} from "@piggo-gg/core"
  ...
  init: (world) => ({
    ...
    onTick: (entities: Entity<Position | Collider | Renderable>[]) => {
      entities.forEach((entity) => {
        const { position, collider, renderable } = entity.components
